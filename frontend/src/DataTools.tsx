      ...
      <section className="panel" aria-labelledby="ai-import-status-heading">
        <div className="section-heading">
          <div>
            ...
            <h3 id="ai-import-status-heading">AI update status</h3>
            <p>
              {lastImport
        ...
        {lastImport && (
          <div className="market-summary-grid">
            ...
            <article className="market-card">
              ...
              <strong>{new Date(lastImport.importedAt).toLocaleString()}</strong>
            </article>
            <article className="market-card">
              <span>Intelligence sections</span>
              <strong>{lastImport.importedSections.length}</strong>
            </article>
            <article className="market-card">
              <span>Review Inbox</span>
              <strong>{lastImport.reviewInboxImported ? "Updated" : "Not included"}</strong>
            </article>
          </div>
        )}
      ...
      <details className="panel operations-tools workspace-sidebar-operations">
        ...
        <div className="operations-grid">
          <section aria-labelledby="ai-exchange-heading">
            ...
            <ol>
              <li>
                <a href={`${apiBase}/api/ai-work-package/export`} download="JOLT_AI_WORK_PACKAGE.json">
